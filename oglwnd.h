...
extern void oglwnd_window_set_wgl_functions(void *data, void *cpf, void *cca);
...
extern void oglwnd_window_props(void *data, int *x, int *y, int *w, int *h, int *wn, int *hn, int *wx, int *hx, int *b, int *d, int *r, int *f, int *l);
